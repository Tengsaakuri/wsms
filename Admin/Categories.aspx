<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Categories.aspx.cs" Inherits="WSMS.Admin.Categories" %>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txt_ID" runat="server" ClientIDMode="Static"
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txt_Category" runat="server" ClientIDMode="Static"
                                    class="form-control" placeholder="Meter Category"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="table-responsive">
                        <asp:Repeater ID="repeat" runat="server">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <asp:Label ID="Id_Label" runat="server" Text='<%#Eval("Category_Id") %>'></asp:Label></td>
                                    <td><%#Eval("Category") %></td>
                                    <td><%#Eval("_Date") %></td>
                                    <td>
